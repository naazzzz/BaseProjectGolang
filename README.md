...
Этот инструмент сохраняет все преимущества Wire (генерация кода провайдеров, статическая типизация), но делает процесс более удобным и управляемым для современных Go-проектов за счет "помечания" структур необходимых для DI.
_____
## Стэк технологий
