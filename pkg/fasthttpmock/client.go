...
func NewClient(pairs *RequestResponsePairs, equal func(*fasthttp.Request, *fasthttp.Request) bool, responseCopy func(*fasthttp.Response, *fasthttp.Response)) *Client {
	return &Client{
		pairs: pairs,
		equal: equal,
		copy:  responseCopy,
