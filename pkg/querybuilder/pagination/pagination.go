...
type Request struct {
	Limit  int `json:"limit" querybuilder:"limit"`
	Offset int `json:"offset" querybuilder:"offset"`
	// Page     int `json:"page" querybuilder:"page"`
	// PageSize int `json:"page_size" querybuilder:"page_size"`
}
